...
Occasionally, I'd embark on a journey that'd get me _really_ close to a new functional site. But just I'd quickly lose the will to finish things when I was 80 percent there--getting that last 20 percent felt impossible. I'd end up in this cycle, in large part, because I kept trying things that were too complex and overdone.

For example, I tried using Next.js in combination with TinaCMS. We use Next.js as our React framework at Valon, so I'm really familiar with it. I successfully got things rendering mostly the way I wanted, but there were a lot of tradeoffs I had to make that I didn't love. For example:
...
I was able to spin up a `v2` of this site in about 11 hours. In comparison, I spent 20+ hours on trying to get my site working on Next.js, and didn't get anywhere close to deployment.
